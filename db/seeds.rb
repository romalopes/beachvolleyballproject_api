...
drills_data = [
  # Strategy Drills
  { title: "Target Serving Analysis", setup_instructions: "Place targets in each corner of the court. Server practices identifying and serving to the weakest receiver. Partners provide feedback on target selection.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "intermediate", skill_titles: ["Which side to choose", "Who to serve on. When serve middle."] },
  { title: "Court Positioning Drill", setup_instructions: "Coach calls out game situations. Players must quickly move to correct court positions and communicate coverage. Emphasize staying close together.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "beginner", skill_titles: ["Court position (always close to each other)", "Who is middle"] },
  { title: "Communication Practice", setup_instructions: "During practice rallies, players must call out every play loudly. Coach evaluates quality and timing of verbal cues between partners.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "beginner", skill_titles: ["Always talk. What to talk. Who talks"] },
  { title: "Wind Reading Exercise", setup_instructions: "Practice serving and hitting with attention to wind direction. Adjust technique based on conditions and discuss strategy adaptations between plays.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "warmup", difficulty_level: "intermediate", skill_titles: ["How to use the wind and sun in your favor"] },
  { title: "Serve Receive Positioning", setup_instructions: "Server serves from various positions. Receiver adjusts starting position based on server tendencies and practices optimal platform angle.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "beginner", skill_titles: ["Position to serve receive"] },
  # Defence Drills
  { title: "Lateral Movement Defence", setup_instructions: "Coach hits balls to alternating sides. Defender practices lateral shuffle and shoulder rotation to get behind each ball with proper platform.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "beginner", skill_titles: ["Lateral/shoulder", "Lateral moving"] },
  { title: "High Ball Defence", setup_instructions: "Coach hits high arcing balls from the opposite end. Defender practices positioning behind the ball and using controlled platform for accurate digs.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "beginner", skill_titles: ["Behind the ball", "Lateral high"] },
  { title: "Tomahawk Practice", setup_instructions: "Coach hits hard-driven balls at close range. Defender practices overhead tomahawk technique for emergency defensive plays.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "intermediate", skill_titles: ["Tomahawk"] },
  { title: "Transition Attack Drill", setup_instructions: "Defender digs a controlled ball, then immediately transitions to attacking position. Setter sets to transitioning player for immediate attack.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "intermediate", skill_titles: ["Transition to attack"] },
  { title: "Hard Driven Ball Dig", setup_instructions: "Attacker hits hard-driven balls at defender. Defender practices low platform technique and body control to absorb pace and redirect to target.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "intermediate", skill_titles: ["Saving hard driven hit - dig", "Saving hard driven hit - high"] },
  { title: "Gator Technique Drill", setup_instructions: "Coach hits hard balls at close range. Defender practices gator dig with hands together and rolling motion for controlled upward redirection.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "advanced", skill_titles: ["Gator"] },
  { title: "Net Ball Recovery", setup_instructions: "Coach tips balls into the net from various angles. Defender practices quick reaction to unpredictable bounces and recovery plays.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "intermediate", skill_titles: ["Saving after ball on the net"] },
  # Set Drills
  { title: "Wall Setting Repetitions", setup_instructions: "Player sets against a wall at varying distances. Focus on hand position, finger spread, and consistent contact point for accuracy.", ideal_num_players: 1, min_players: 1, max_players: 1, training_stage: "warmup", difficulty_level: "beginner", skill_titles: ["Handset", "Foot work"] },
  { title: "Back Set Practice", setup_instructions: "Setter practices back sets to a target behind them. Focus on body rotation, arm extension, and consistent release point for accuracy.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "intermediate", skill_titles: ["Back set"] },
  { title: "Deep Court Setting", setup_instructions: "Setter positioned deep in court practices setting to attackers. Focus on higher arc and stronger arm action to create effective attack opportunities.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "intermediate", skill_titles: ["From back of the court"] },
  { title: "Short Set Timing", setup_instructions: "Setter and hitter practice quick combination plays. Focus on minimal ball travel time and precise timing for fast attacks.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "advanced", skill_titles: ["Short set"] },
  { title: "Emergency Back Set", setup_instructions: "Coach feeds difficult balls that require back setting. Setter practices technique under pressure for emergency back set situations.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "advanced", skill_titles: ["Back set in emergency"] },
  { title: "Wind Setting Adjustment", setup_instructions: "Practice setting in windy conditions. Adjust arc, speed, and contact point to compensate for wind effects on ball trajectory.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "intermediate", skill_titles: ["Set with wind"] },
  # Attack Drills
  { title: "Approach and Hit Timing", setup_instructions: "Practice the 3-step approach with proper timing to the set. Focus on building momentum and connecting with the ball at peak height.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "beginner", skill_titles: ["Steps to hit", "Nike position"] },
  { title: "Cross Court Hitting", setup_instructions: "Setter sets to attacker who practices hitting diagonally across court. Focus on arm angle and wrist control for accurate placement.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "intermediate", skill_titles: ["Cross", "Rotation of arms and body"] },
  { title: "Line Shot Practice", setup_instructions: "Attacker practices hitting down the line with high trajectory. Focus on going over the block and landing deep near the sideline.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "intermediate", skill_titles: ["High line"] },
  { title: "Cut Shot Technique", setup_instructions: "Attacker practices short cut shots at sharp angles. Focus on wrist snap and hand control to cut the ball at extreme angles.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "advanced", skill_titles: ["Short cut"] },
  { title: "Drop Shot Deception", setup_instructions: "Attacker shows full hitting motion then executes soft drop shot. Focus on deception and touch to place ball just over the block.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "advanced", skill_titles: ["Drop shot"] },
  { title: "Block Tooling Drill", setup_instructions: "With a blocker at net, attacker practices hitting off the outside hand. Aim for deflections out of bounds off the blocker.", ideal_num_players: 3, min_players: 2, max_players: 4, training_stage: "beginning", difficulty_level: "advanced", skill_titles: ["Challenge the block"] },
  { title: "Quick Set Attack", setup_instructions: "Setter delivers short sets for immediate attack. Hitter practices fast approach timing and compact swing for quick combination plays.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "advanced", skill_titles: ["Short set", "Hit on second"] },
  { title: "Tight Net Ball Handling", setup_instructions: "Setter delivers sets tight to the net. Attacker practices open hand technique to push or roll balls over while avoiding net violations.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "advanced", skill_titles: ["Ball too close to the net"] },
  # Block Drills
  { title: "Block Communication Signals", setup_instructions: "Practice hand signals behind the back to indicate blocking coverage. Partners must read signals and position accordingly before each play.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "beginner", skill_titles: ["Signs"] },
  { title: "Block Footwork Patterns", setup_instructions: "Practice lateral movement along the net for blocking. Focus on shuffle steps and crossover techniques to position efficiently.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "middle", difficulty_level: "beginner", skill_titles: ["Foot work"] },
  { title: "Peel and Defence Transition", setup_instructions: "Blocker practices stepping away from net to defend various shot types. Quick transition from blocking to defensive stance for short and deep balls.", ideal_num_players: 3, min_players: 2, max_players: 4, training_stage: "end", difficulty_level: "intermediate", skill_titles: ["Peel - Short", "Peel - Long", "Peel - Hard driven"] },
  { title: "Line Block Positioning", setup_instructions: "Practice setting the block to cover the line shot. Outside hand aligns with sideline to seal off the angle and force cross-court.", ideal_num_players: 3, min_players: 2, max_players: 4, training_stage: "beginning", difficulty_level: "intermediate", skill_titles: ["Block line"] },
  { title: "Cross Court Block Setup", setup_instructions: "Position the block to cover cross-court shots. Inside hand covers middle, outside hand seals the cross-court angle to force line shots.", ideal_num_players: 3, min_players: 2, max_players: 4, training_stage: "middle", difficulty_level: "intermediate", skill_titles: ["Block cross"] },
  { title: "Serve and Block Transition", setup_instructions: "Server immediately transitions to blocking position after serving. Practice quick movement up to net to establish block against the return.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "end", difficulty_level: "intermediate", skill_titles: ["Serve and go to block"] },
  { title: "Block Landing and Turn", setup_instructions: "Practice proper landing technique after blocking and quick body rotation. Transition from blocking stance to defensive or attacking readiness.", ideal_num_players: 2, min_players: 2, max_players: 2, training_stage: "beginning", difficulty_level: "beginner", skill_titles: ["How to turn after block"] },
  # Serve Drills
  { title: "Target Serving", setup_instructions: "Place targets in various court locations. Server practices hitting specific zones with consistency. Track success rate for each target area.", ideal_num_players: 1, min_players: 1, max_players: 1, training_stage: "warmup", difficulty_level: "beginner", skill_titles: ["Direction", "Short", "Long"] },
  { title: "Jump Float Serve Practice", setup_instructions: "Practice jump float serve technique focusing on minimal spin and unpredictable ball movement. Aim for consistent contact point and float action.", ideal_num_players: 1, min_players: 1, max_players: 1, training_stage: "warmup", difficulty_level: "intermediate", skill_titles: ["Jump float", "Arm swing"] },
  { title: "Jump Serve Power", setup_instructions: "Execute aggressive jump serves with topskin for power and downward trajectory. Focus on approach timing, contact point, and follow through.", ideal_num_players: 1, min_players: 1, max_players: 1, training_stage: "middle", difficulty_level: "advanced", skill_titles: ["Jump serve", "Arm swing"] },
  { title: "Environmental Serving", setup_instructions: "Practice serving with attention to wind and sun conditions. Adjust position and technique based on environmental factors for optimal results.", ideal_num_players: 1, min_players: 1, max_players: 1, training_stage: "warmup", difficulty_level: "intermediate", skill_titles: ["Position of serve wind/sun"] },
]

drills_data.each do |drill_data|
  skill_titles = drill_data.delete(:skill_titles)
  ideal = drill_data.delete(:ideal_num_players) || drill_data.delete(:player_count) || 4
  stage = drill_data.delete(:training_stage) || "beginning"
  min_players = drill_data.delete(:min_players)
  max_players = drill_data.delete(:max_players)
  min_players ||= ideal == 1 ? 1 : [ideal - 1, 1].max
  max_players ||= ideal == 1 ? 1 : (ideal == 3 ? 4 : ideal + 1)
  ideal = [[ideal, min_players].max, max_players].min
  drill = Drill.find_or_create_by!(title: drill_data[:title]) do |d|
    d.setup_instructions = drill_data[:setup_instructions]
    d.training_stage = stage
    d.difficulty_level = drill_data[:difficulty_level]
    d.min_players = min_players
